                ...
                <div className="max-w-7xl mx-auto px-6 md:px-10 lg:px-16">
                    <div className="flex items-center justify-between h-20">
                        ...
                        <div className="hidden md:flex items-center space-x-4">
                            ...
                            {userRole === 'guest' ? (
                                <>
                                    <Button variant="ghost" className="flex items-center gap-2 text-base text-muted-foreground hover:text-primary" onClick={() => openAuthModal('login')}>
                                        <LogIn className="w-5 h-5" /> <span>Masuk</span>
                                    </Button>
                                    <Button className="flex items-center gap-2 bg-gradient-to-r from-blue-600 to-cyan-500 hover:from-blue-700 hover:to-cyan-600 text-white px-6 py-3 rounded-full text-base shadow-md" onClick={() => openAuthModal('register')}>
                        ...
                        >
                            <nav className="flex flex-col space-y-4 px-6 py-6">
                                ...
                                <div className="flex flex-col space-y-4 pt-6 border-t border-border">
                                    <Button variant="ghost" className="flex items-center gap-2 text-base text-muted-foreground" onClick={() => openAuthModal('login')}>
                                        <LogIn className="w-5 h-5" /> <span>Masuk</span>
                                    </Button>
                                    <Button className="flex items-center gap-2 bg-gradient-to-r from-blue-600 to-cyan-500 text-white px-6 py-3 rounded-full text-base" onClick={() => openAuthModal('register')}>
                                        <UserPlus className="w-5 h-5" /> <span>Daftar</span>
                                    </Button>
                                </div>
                            </nav>
